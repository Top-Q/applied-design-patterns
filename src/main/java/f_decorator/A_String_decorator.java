...
class MagicString {
    ...
    public long countVowels() {
        return string.chars()
                // They come as integers from some reason
                .mapToObj(c -> (char) c)
                // Let's filter the vowels
    ...
    public static void main(String[] args) {
        ...
        System.out.println(s + " has " + s.countVowels() + " vowels");
        // There is no inheritance here, so we can't do:
//        String foo = new MagicString("sds");
